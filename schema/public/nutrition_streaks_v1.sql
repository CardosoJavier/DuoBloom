...
CREATE POLICY "Users can view own and partner streaks" ON "nutrition_streaks" FOR
SELECT
    USING (
        auth.uid () = user_id
        OR EXISTS (
...
CREATE POLICY "Users can insert own streaks" ON "nutrition_streaks" FOR INSERT
WITH
