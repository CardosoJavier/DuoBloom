...
export const calendarWeekDaysHeaderStyle = tva({
  base: "flex-row justify-between border-b border-outline-200 dark:border-outline-800 pb-3 mb-3 w-full",
  variants: {},
});
...
export const calendarWeekDayTextStyle = tva({
  base: "text-center text-xs font-bold text-typography-500 dark:text-typography-300 uppercase tracking-wider",
  variants: {},
  parentVariants: {},
});
...
export const calendarWeekStyle = tva({
  base: "flex-row justify-between w-full mb-2",
  variants: {},
});
...
export const calendarDayStyle = tva({
  ...
  variants: {
    state: {
      ...
      selected:
        "bg-primary-500 hover:bg-primary-600 active:bg-primary-700 rounded-full",
      today:
        "border-[1.5px] border-primary-500 bg-primary-50 dark:bg-primary-950/20 rounded-full active:opacity-70",
...
export const calendarDayTextStyle = tva({
  ...
  variants: {
    state: {
      default: "text-typography-900 dark:text-white font-semibold",
      selected: "text-white font-semibold",
      today: "text-primary-500 font-semibold",
