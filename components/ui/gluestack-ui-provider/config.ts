...
export const config = {
  light: vars({
    ...
    /* Background */
    "--color-background-0": "249 250 251",
    ...
    "--color-background-widget": "255 255 255",
  ...
  dark: vars({
    ...
    /* Background (Dark - Matches Light config which was already dark) */
    ...
    "--color-background-widget": "30 41 59",
